...
- Does Roblox have any plans to make triple-A games or focus on a UGC platform?
- What do you think about meta's metaverse?  In what aspect do you think Roblox is doing better than or differently from Meta?
...
As a result, I have made many friends in the community. At the same time, I enriched my knowledge based on other's knowledge and practiced my skills. Programming language is a tool, and the more skilled I use it, the more I can deal with the complex scenario.
...
For the rest of the part, such as thread pool and memory lead detections, I also spend some time on it. Finally, my server can fulfill the C10K requirement, and I also learned a lot of things from this project.
...
For this experience, it is not a actual project. It is an appendage of my learning route. I'm takeing an cource called open source software in medical image processing. Our final project is to use ITK or VTK framework to implement our own medical image processing application. In this field, most of the application and frameworks are developed by using C++. So we have to use C++ to finish my project. But the problem is  here. Most of my classmates are have no experiences on C++. And most of them are not major in computer science in the collage. Also, they often use python or matlab to do some image processing. This course is a graduate-level course, so of course, professor can't teach us C++ step by step just like those intro-level class. So let them use C++  to develop an software is a really big challange. 

The challange comes from three part. The first part is basic knowledges of C++. It includes some basic grammar, rules and knowledges such as pointers and references, how to compile it and what is cmake. What is heap and What is operator new. This is not the biggest challange because learn this part won't take too long.

The second part is the biggest challange. It is the usage of standard template library. They don't have any experiences on using c++, so they don't know how to use them properly or even don't know it is exist. For example the container. Some student only using python can not understand what is vector, and what kind of thing should be typed in the angle brasket which after the vector. And they can't understand what is iterator. For something more advanced, what is smart pointer? what is function pointers and how to use call back functions? Something more may be multi threading? There are a tons of things need to know.

At the same time, if they want to find something on internet, that will be a dezaster. Because most of those blogs, tutorials need their audience has some prerequsities. Unforturnally, they don't . So they have to search those prerequesities, so and so on. They will waste a lot of times on it. 

The third part is read the code. We must use ITK/VTK skeletons. So if they don't have those knowledges i mentioned before, that is really hard. 

So study those things need a lot of C++ knowledges and practices. Obviously, let them study c++ from the begin is imposible. 

But my primary language is C++, I have some experiences on it. Also, I write a lot of notes and summarized a lot of tips from books when I'm studying C++. So I decide to use those meterials to help my classmates. I rearrange my notes. I discard some complex theory, and add more tips rules, cases and examples into it. And rearrange the order of the content. Then I discussed this thing with my professor. During discusstion, i found that my professor also annoying with this problem. There are always alot of students in the office hour and some questions are similar. So I told her I arranged my note into a pdf and may be we can post it on the course website. Then students can check the pdf first, it that doesn't cover their question, they can come to office hour. At the same time I say I can help her to answer those C++ questions. But for some question related with ITK/VTK, I might can't answer because I'm also a beginner with this framework. She is really surprised and happy. And she post the pdf to our slack channel. And my classmates also fell really happy because they really need a guide to help them finish their project. I also really happy because I really did something based on my working and help my professor and classmates a lot. 
