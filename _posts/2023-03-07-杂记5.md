...
int main() {
    ...
    double c{3.2};
    std::string d{"hello"};
    auto t = std::tuple{std::ref(a), std::ref(b), std::cref(c), std::cref(d)};
...
![image-20241017113701931](/../../../AppData/Roaming/Typora/typora-user-images/image-20241017113701931.png)
